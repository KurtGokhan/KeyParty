...
Initial release of KeyParty — a full-screen, kid-proof key-smashing toy where every key, click, and drag bursts into color and sound, and nothing a child mashes can quit the game or escape to the OS. Ships as a desktop app for **macOS** and **Windows**, plus a browser version.
